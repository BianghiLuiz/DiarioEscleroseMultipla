...
public class AddRemediosActivity extends AppCompatActivity {
        ...
        adicionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ( Definirnome.isEmpty()) {
                    ...
                    Toast.makeText(getBaseContext(),"Remedio inserido com sucesso.", Toast.LENGTH_SHORT).show();

                } else{
                    Toast.makeText(getBaseContext(),"Favor preencher os campos obrigatórios", Toast.LENGTH_SHORT).show();
                }

                Intent intent = new Intent(AddRemediosActivity.this, Remedios.class);
